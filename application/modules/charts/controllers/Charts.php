...
class Charts extends CI_Controller {
	...
	public function chartJS()
	{
		...
		$content = $this->load->view('chartJS',array(),TRUE);
		$sideBar = $this->obackend->sidebar(13);
	...
	public function morris()
	{
		...
		$content = $this->load->view('morris',array(),TRUE);
		$sideBar = $this->obackend->sidebar(14);
		$viewData = $this->obackend->full(array('css'=>$cssList,'sidebar'=>$sideBar,'content'=>$content,'js'=>$jsList));
		$activeTemplate = $this->obackend->getActiveTemplate();
		$this->parser->parse($activeTemplate.'template',$viewData);
	}
	...
	public function flot()
	{
		...
		$jsList = array(
			'link'=>array(
				...
				site_url().'assets/skin/dist/js/app.min.js',
				site_url().'assets/skin/dist/js/demo.js',
				site_url().'assets/skin/plugins/flot/jquery.flot.min.js',
				site_url().'assets/skin/plugins/flot/jquery.flot.resize.min.js',
				site_url().'assets/skin/plugins/flot/jquery.flot.pie.min.js',
				site_url().'assets/skin/plugins/flot/jquery.flot.categories.min.js',
			),
			'script'=>array(
				'
					$(function () {
		...
		$content = $this->load->view('flot',array(),TRUE);
		$sideBar = $this->obackend->sidebar(15);
		$viewData = $this->obackend->full(array('css'=>$cssList,'sidebar'=>$sideBar,'content'=>$content,'js'=>$jsList));
		$activeTemplate = $this->obackend->getActiveTemplate();
		$this->parser->parse($activeTemplate.'template',$viewData);
	}
	...
	public function inline()
	{
		...
		$content = $this->load->view('inline',array(),TRUE);
		$sideBar = $this->obackend->sidebar(16);
		$viewData = $this->obackend->full(array('css'=>$cssList,'sidebar'=>$sideBar,'content'=>$content,'js'=>$jsList));
		$activeTemplate = $this->obackend->getActiveTemplate();
		$this->parser->parse($activeTemplate.'template',$viewData);
	}
