...
<section id="layout">
  ...
  <div class="callout callout-danger lead">
    <h4>Tip!</h4>
    <p>The <a href="<?php echo site_url('starter'); ?>">starter page</a> is a good place to start building your app if you'd like to start from scratch.</p>
  </div>
...
<section id="components" data-spy="scroll" data-target="#scrollspy-components">
  ...
  &LT;a href="<?php echo site_url('home'); ?>" class="logo">
    &LT;!-- LOGO -->
    AdminLTE
  &LT;/a>
        ...
        <nav class="navbar navbar-static-top">
          <div class="container-fluid">
            <div class="navbar-header">
              <a href="<?php echo site_url('home'); ?>" class="navbar-brand"><b>Admin</b>LTE</a>
...
&LT;header class="main-header">
  &LT;nav class="navbar navbar-static-top">
    ...
    &LT;div class="navbar-header">
      &LT;a href="<?php echo site_url('home'); ?>" class="navbar-brand">&LT;b>Admin&LT;/b>LTE&LT;/a>
        ...
        <div class="box-body">
          ...
          <div class="direct-chat-contacts">
            <ul class="contacts-list">
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="<?php echo site_url(); ?>assets/skin/dist/img/user1-128x128.jpg" alt="Contact Avatar">
  ...
  &LT;div class="box-body">
    ...
    &LT;div class="direct-chat-messages">
      ...
      &LT;div class="direct-chat-msg">
        ...
        &LT;img class="direct-chat-img" src="<?php echo site_url(); ?>assets/skin/dist/img/user1-128x128.jpg" alt="message user image">&LT;!-- /.direct-chat-img -->
      ...
      &LT;div class="direct-chat-msg right">
        ...
        &LT;/div>&LT;!-- /.direct-chat-info -->
        &LT;img class="direct-chat-img" src="<?php echo site_url(); ?>assets/skin/dist/img/user3-128x128.jpg" alt="message user image">&LT;!-- /.direct-chat-img -->
        &LT;div class="direct-chat-text">
          You better believe it!
        &LT;/div>&LT;!-- /.direct-chat-text -->
      &LT;/div>&LT;!-- /.direct-chat-msg -->
    ...
    &LT;div class="direct-chat-contacts">
      &LT;ul class="contacts-list">
        &LT;li>
          &LT;a href="#">
            &LT;img class="contacts-list-img" src="<?php echo site_url(); ?>assets/skin/dist/img/user1-128x128.jpg" alt="Contact Avatar">
